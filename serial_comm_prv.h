...
typedef enum __attribute__((packed)) {
    ...
    FLASH_WRITE_ERR = 0x08, // After writing a block of data to flash, the ROM loader reads the
                            // value back and the 8-bit CRC is compared to the data read from flash.
                            // If they don't match, this error is returned.
